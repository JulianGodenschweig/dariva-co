    ...
    <>
      ...
      <section className="aurora relative overflow-hidden">
        ...
        <div className="container-page relative grid min-h-[calc(100vh-5rem)] items-center gap-12 py-14 lg:grid-cols-[1.02fr_0.98fr]">
          <Reveal>
            <p className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#cae3e4] bg-white/70 px-4 py-2 text-sm font-semibold text-[#06646f]">
              <Waves size={14} />
              Namibia&apos;s community mental wellness ecosystem
            </p>
            <h1 className="text-balance text-5xl font-semibold tracking-[-0.04em] text-[#0d2233] sm:text-6xl lg:text-7xl">
              Like a river, wellness flows when the community opens the channel.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-[#496373] sm:text-xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Link href="/apply" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#0d2233] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#0a8f9c]">
                Apply Now <ArrowRight size={17} />
              </Link>
              <Link href="/program" className="inline-flex items-center justify-center rounded-full border border-[#bdd8dc] bg-white/70 px-6 py-3 text-sm font-semibold text-[#0d2233] transition hover:bg-white">
                Learn More
              </Link>
              <Link href="/contact" className="inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-semibold text-[#0a8f9c] transition hover:text-[#06646f]">
                Partner With Us
              </Link>
            </div>
          </Reveal>
              ...
              <div className="surface rounded-2xl p-5 sm:p-7">
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  {[
                    ...
                    return (
                      <div key={item.label} className="rounded-2xl border border-[#dce9ec] bg-white p-4">
                        <Icon className="mb-5 text-[#0a8f9c]" size={22} />
                        <p className="text-sm font-semibold text-[#0d2233]">{item.label}</p>
                      </div>
                    );
                  })}
                </div>
        ...
        <div className="container-page grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <Stagger className="grid gap-4">
            {[
              ...
              <StaggerItem key={title} className="rounded-2xl border border-[#dce9ec] bg-[#fbfefd] p-6">
                <ShieldAlert className="mb-4 text-[#e76f51]" size={24} />
                <h3 className="text-xl font-semibold text-[#0d2233]">{title}</h3>
      ...
      {/* ── Impact stats ── */}
      <section className="section-pad bg-[#fbfefd]">
        <div className="container-page">
          <SectionHeading
            align="center"
            eyebrow="Impact"
          ...
          <Stagger className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {outcomes.map((outcome) => (
              <StaggerItem key={outcome} className="rounded-2xl border border-[#dce9ec] bg-white p-5 text-center text-sm font-semibold text-[#0d2233]">
                {outcome}
              </StaggerItem>
            ))}
          </Stagger>
        ...
        <div className="container-page grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <Stagger className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              const Icon = item.icon;
              return (
                <StaggerItem key={item.title} className="rounded-2xl border border-[#dce9ec] bg-[#fbfefd] p-6">
                  <Icon className="mb-4 text-[#0a8f9c]" size={24} />
                  <h3 className="text-lg font-semibold text-[#0d2233]">{item.title}</h3>
                  <p className="mt-2 text-sm leading-7 text-[#5e7384]">{item.text}</p>
                </StaggerItem>
              );
            })}
          </Stagger>
              ...
              {[
                ...
                return (
                  <StaggerItem key={item.title} className="surface rounded-2xl p-6 transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_80px_rgba(13,34,51,0.12)]">
                    ...
                    <p className="mt-3 text-sm leading-7 text-[#5e7384]">{item.text}</p>
                  </StaggerItem>
                );
              })}
            </Stagger>
        ...
        <div className="container-page">
          ...
          <div className="mx-auto mt-12 grid max-w-4xl gap-6 md:grid-cols-2">
            {[
              ...
              <Reveal key={block.title} className="rounded-2xl border border-[#dce9ec] bg-[#fbfefd] p-6">
                <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#0a8f9c]">{block.phase}</p>
                <h3 className="mt-2 text-2xl font-semibold tracking-[-0.02em] text-[#0d2233]">{block.title}</h3>
                <ul className="mt-4 grid gap-2">
                  {block.items.map((item) => (
                    <li key={item} className="flex items-start gap-2 text-sm text-[#496373]">
                      <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-[#0a8f9c]" size={16} />
                      {item}
                    </li>
                  ))}
                </ul>
      ...
      <section className="section-pad bg-white">
        <div className="container-page grid gap-12 lg:grid-cols-2">
          ...
          />
          <Reveal className="rounded-2xl border border-[#dce9ec] bg-[#0d2233] p-8 text-white">
            <HandHeart className="mb-8 text-[#77d2d8]" size={34} />
      ...
      <section className="section-pad bg-[#0d2233] text-white">
        <Reveal className="container-page text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link href="/apply" className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#0d2233] transition hover:bg-[#dff1ef]">
              Apply Now <ArrowRight size={17} />
            </Link>
      ...
      <section className="section-pad bg-[#f2f8f7]">
        <div className="container-page">
          ...
          <div className="mx-auto mt-10 grid max-w-4xl gap-4">
            {faqs.map((faq) => (
              <Reveal key={faq.q} className="rounded-2xl border border-[#dce9ec] bg-white p-6">
                <h3 className="text-lg font-semibold text-[#0d2233]">{faq.q}</h3>
                <p className="mt-3 text-sm leading-7 text-[#5e7384]">{faq.a}</p>
              </Reveal>
            ))}
          </div>
        </div>
